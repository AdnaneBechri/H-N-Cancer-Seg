...
def runTraining(opts):
    ...
    # Define UNet_FEE_3mod
    # To-Do. Get as input the config settings to create different networks
    if (opts.numModal == 2):
        hdNet = UNet_FEE(in_dim = 3, out_dim = 1, num_filters = 4)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--modelName', type=str, default='UNet_FEE_3mod', help='name of the model')
