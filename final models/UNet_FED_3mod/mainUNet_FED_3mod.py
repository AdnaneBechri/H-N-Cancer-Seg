...
def runTraining(opts):
    ...
    # Define UNet_FED_3mod
    # To-Do. Get as input the config settings to create different networks
    if (opts.numModal == 2):
        hdNet = UNet_FED(in_dim = 1, out_dim = 1, num_filters = 4)
    ...
    for e_i in range(epoch):
        ...
        for b_i in range(numBatches):
            ...
            segmentation_prediction = segmentation_prediction.reshape(segmentation_prediction.numel() // num_classes, num_classes)
            if e_i == 0 and b_i == 0:
...
if __name__ == '__main__':
    ...
    parser.add_argument('--modelName', type=str, default='UNet_FED_3mod', help='name of the model')
