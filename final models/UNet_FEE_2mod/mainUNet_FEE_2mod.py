...
if __name__ == '__main__':
    ...
    parser.add_argument('--modelName', type=str, default='UNet_FEE_2mod', help='name of the model')
    ...
    parser.add_argument('--numEpochs', type=int, default=251, help='Number of epochs')
